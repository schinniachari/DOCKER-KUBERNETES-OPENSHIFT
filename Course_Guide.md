...
## :file_folder: [Week 1: Understanding the Benefits of Containers](https://github.com/schinniachari/DOCKER-KUBERNETES-OPENSHIFT/tree/dev/Week%201)
...
## :file_folder: [Week 2: Understanding Kubernetes Architecture](https://github.com/schinniachari/DOCKER-KUBERNETES-OPENSHIFT/tree/dev/Week%202)
...
## :file_folder: [Week 3: Managing Applications with Kubernetes](https://github.com/schinniachari/DOCKER-KUBERNETES-OPENSHIFT/tree/dev/Week%203)
...
## :file_folder: [Week 4: The Kubernetes Ecosystem](https://github.com/schinniachari/DOCKER-KUBERNETES-OPENSHIFT/tree/dev/Week%204)
...
## :file_folder: [Week 5: Final Assignment - Build and Deploy a Guestbook App](https://github.com/schinniachari/DOCKER-KUBERNETES-OPENSHIFT/tree/dev/Week%205)
